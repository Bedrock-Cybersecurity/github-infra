...
# Cirius-Group-Inc/cirius-github-infra. These imports adopt them into this state so
...
#
# bedrock-github-infra (this repo) has NO existing main protection — it will be created
# fresh on first apply. No import needed for it.
#
# SEQUENCE: Apply this repo BEFORE removing bedrock resources from
# Cirius-Group-Inc/cirius-github-infra. Both states temporarily co-own the same
